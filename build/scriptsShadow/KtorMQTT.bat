...
set CLASSPATH=%APP_HOME%\lib\KtorMQTT-all.jar

@rem Execute KtorMQTT
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %KTOR_MQTT_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%KTOR_MQTT_EXIT_CONSOLE%" exit 1
exit /b 1
